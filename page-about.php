...
<?php get_header(); ?>
 	<section >
		...
		<div class="container">
			...
			<div class="row padding-row about-row">
				<h1 class="section-title">О ресторане</h1>

				<div class=" clearfix">
					<div class="col-md-4">
						<img src="<?php  echo get_theme_file_uri( '/assets/images/img1.jpg' ) ?>"> 
					...
					<div class="col-md-8 clearfix"> 
						...
						<img id="second-image" src="<?php  echo get_theme_file_uri( '/assets/images/2.jpg' ) ?>">
						<img id="third-image" src="<?php  echo get_theme_file_uri( '/assets/images/img3.jpg' ) ?>">
